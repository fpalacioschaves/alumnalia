...
-- Tiempo de generación: 17-06-2025 a las 14:22:33
...
INSERT INTO `banco_preguntas_en_examen` (`examen_id`, `pregunta_id`) VALUES
(2, 1),
(3, 1);
...
INSERT INTO `examenes` (`id`, `titulo`, `descripcion`, `asignatura_id`, `fecha`, `hora`, `tipo`) VALUES
(2, 'Examen Final Tercer Trimestre', '', 3, '2025-06-07', '11:30:00', 'evaluación'),
(3, 'Test de examen', 'Testeo del banco de preguntas', 1, '2025-07-31', '12:30:00', 'evaluación');
